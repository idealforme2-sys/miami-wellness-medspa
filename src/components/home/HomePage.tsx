  ...
  return (
    <>
      ...
      {announcements.length > 0 && (
        <div
          className="fixed top-0 z-[60] w-full px-4 py-2 text-center text-xs font-medium tracking-[0.14em]"
          style={{
            background: "linear-gradient(90deg, rgba(201,169,110,0.1), rgba(7,7,11,0.95), rgba(201,169,110,0.1))",
        ...
        >
          ...
          {announcements[0].href && announcements[0].label && (
            <a
              ...
              className="ml-3 inline-flex items-center rounded-full px-3 py-0.5 text-[0.6rem] uppercase tracking-[0.14em] transition-colors"
              style={{
